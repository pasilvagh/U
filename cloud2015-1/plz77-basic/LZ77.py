...
class LZ77Compressor:
	...
	def separateData(self, input_file_path, output_file_path=None, sep=2):
		...
		#Separar el texto en varios inputs
		separated = [data[i::sep] for i in xrange(sep)]


		return  separated

	def compress(self, input_file_path, output_file_path=None, sep=2):
		"""
...
'''
		...
		while i < len(data):
			...
			if match: 
				...
				output_buffer.frombytes(True) # valor 0
